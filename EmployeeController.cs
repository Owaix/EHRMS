...
namespace EHRMS.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        private GenericRepository<EmployeeBasicInfo> EmpBasic;
        ...
        public EmployeeController()
        {
            ...
            EmpBasic = unitOfWork.Repository<EmployeeBasicInfo>();
        }
        ...
        public ActionResult New(HttpPostedFileWrapper[] fileup)//String[] Ins, String[] Deg, String[] Year)
        {
            ...
            empbasic.SurName = emp.SurName;
            empbasic.Gender = emp.Gender;
            empbasic.DateOfBirth = emp.DateOfBirth;
            empbasic.CNIC = emp.CNIC;
            empbasic.Religion = emp.Religion;
            empbasic.Domicile = emp.Domicile;
            empbasic.Address = emp.Address;
            empbasic.State = emp.State;
            empbasic.Country = emp.Country;
            empbasic.PostalCode = emp.PostalCode;
            empbasic.HomePhone = emp.HomePhone;
            empbasic.MobilePhone = emp.MobilePhone;
            empbasic.EmailAddress = emp.EmailAddress;
            unitOfWork.Save();
